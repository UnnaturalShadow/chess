...
public class ChessGame
{
    ...
    private boolean isEnemyThreatAt(int row, int col, TeamColor teamColor, ChessPosition kingPosition)
    {
        ...
        if(currentPiece == null || currentPiece.getTeamColor() == teamColor) return false;
